...
/**
 * radix_counting_sort - Function that sort the significant digits
 *                       of an array of integers in ascending order
 *                       using the counting sort algorithm.
 * @array: input param (An array of integers)
 * @size: input param (The size of the array)
 * @sig: input param (The significant digit to sort on)
